...
- [Vídeos (YouTube)](#vídeos-youtube)
   ...
   - [O que eu acho dos SaaS da Bolha Dev](#vídeos-youtube)
   - [Usei a AbacatePay no meu Micro SaaS e foi incrível](#vídeos-youtube)
   - [Usando AbacatePay em .NET API](#vídeos-youtube)
   - [Como esse Saas Transacionou R$ 20 Milhões em 10 Meses (Daniel Lima)](#vídeos-youtube)
   - [Como integrar com Woocommerce](#vídeos-youtube)
   - [Como integrar com Lovable](#vídeos-youtube)
...
- [Node.js](https://www.npmjs.com/package/@abacatepay/sdk) - SDK para Node.js, compatível com TypeScript e ES modules.
...
- [Ruby](https://github.com/AbacatePay/abacatepay-ruby-sdk) - SDK para Ruby 2.6+, disponível como gem e com suporte a Rails.
- [Go](https://github.com/AbacatePay/abacatepay-go-sdk) - SDK para Go 1.13+, com suporte a módulos e generics.
...
- [Como esse Saas Transacionou R$ 20 Milhões em 10 Meses (Daniel Lima)](https://youtu.be/OY5ap_6KZco?si=vCKpsuErpcMnyOrg) - [CEO](https://www.instagram.com/daniellimae) da AbacatePay revela como construiu a AbacatePay e já transacionou mais de R$20 milhões.
